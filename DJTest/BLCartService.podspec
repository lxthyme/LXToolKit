...
Pod::Spec.new do |s|
  ...
  s.name         = "BLCartService"
  s.version      = "29"
  s.summary      = "BLCartService."
  ...
  s.description  = <<-DESC
                    this is BLCartService
                   DESC

  s.homepage     = "https://gitlab.bl.com/iOS_Business/BLCartService"
  ...
  s.source       = { :git => "https://gitlab.bl.com/iOS_Business/BLCartService.git", :tag => s.version.to_s }
  ...
  s.source_files  = "BLCartService/BLCartService/**/*.{h,m}"
  ...
  s.dependency "BLBusinessContext"
