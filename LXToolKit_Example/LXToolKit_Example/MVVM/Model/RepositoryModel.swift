...
struct RepositorySearchModel: HandyJSON {
    // MARK: 🔗Vaiables
...
extension RepositorySearchModel {
...
struct TrendingRepositoryModel: HandyJSON {
    var author: String?
    var name: String?
    var url: String?
...
extension TrendingRepositoryModel: Equatable {
    static func == (lhs: TrendingRepositoryModel, rhs: TrendingRepositoryModel) -> Bool {
        return lhs.fullname == rhs.fullname
    }
}
