...
public extension Swifty where Base: SFColor {
    ...
    var rgbComponents: (red: Int, green: Int, blue: Int) {
        let components: [CGFloat] = {
            let comps: [CGFloat] = base.cgColor.components!
...
public extension Swifty where Base: SFColor {
    ...
    static func rgba(red: Int, green: Int, blue: Int, transparency: CGFloat = 1) -> SFColor? {
    ...
    static func argbHexString(_ argbHexString: String) -> SFColor? {
        ...
        return rgba(red: red, green: green, blue: blue, transparency: CGFloat(alpha) / 255)
    }
    ...
    static func complementary(for color: SFColor) -> SFColor? {
        ...
        let green: CGFloat = sqrt(pow(255.0, 2.0) - pow(componentColors[1] * 255, 2.0)) / 255
        let blue: CGFloat = sqrt(pow(255.0, 2.0) - pow(componentColors[2] * 255, 2.0)) / 255
        return SFColor.init(red: red, green: green, blue: blue, alpha: 1.0)
    }
