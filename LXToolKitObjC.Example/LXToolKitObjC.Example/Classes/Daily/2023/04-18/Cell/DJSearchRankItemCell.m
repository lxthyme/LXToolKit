...
@interface DJSearchRankItemCell()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout, UICollectionViewDelegateLeftAlignedLayout> {
}
...
@property(nonatomic, strong)DJGoodsPriceView *normalPriceView;
@property(nonatomic, strong)DJGoodsPriceView *huaXianPriceView;
@property(nonatomic, strong)UIImageView *imgViewAddCart;
@property(nonatomic, strong)DJGoodsTagCell *tagCell;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    DJGoodsTagCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DJGoodsTagCell" forIndexPath:indexPath];
    NSArray *tagList = self.item[@"tagList"];
...
- (void)prepareCollectionView {
    [self.tagCollectionView registerClass:[DJGoodsTagCell class] forCellWithReuseIdentifier:@"DJGoodsTagCell"];
}
- (void)prepareUI {
...
- (DJGoodsPriceView *)normalPriceView {
    if(!_normalPriceView){
        DJGoodsPriceView *v = [[DJGoodsPriceView alloc]init];
        _normalPriceView = v;
    }
    return _normalPriceView;
}
- (DJGoodsPriceView *)huaXianPriceView {
...
- (DJGoodsTagCell *)tagCell {
    if(!_tagCell){
        DJGoodsTagCell *v = [[DJGoodsTagCell alloc]initWithFrame:CGRectZero];
        _tagCell = v;
    }
    return _tagCell;
}
