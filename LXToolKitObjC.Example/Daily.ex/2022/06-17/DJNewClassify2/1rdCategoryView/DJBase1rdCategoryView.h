...
// typedef NS_ENUM(NSInteger, DJFirstCategoryType) {
//     /// 仅一行时的样式
//     DJFirstCategoryTypeFold,
//     /// 展开后的样式
//     DJFirstCategoryTypeUnfold,
// };

NS_ASSUME_NONNULL_BEGIN

@interface DJBase1rdCategoryView : LXBaseView<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
}
