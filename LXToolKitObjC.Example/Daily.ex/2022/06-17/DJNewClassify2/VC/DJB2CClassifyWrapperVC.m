...
@interface DJB2CClassifyWrapperVC()<JXCategoryViewDelegate, JXCategoryListContainerViewDelegate/**, JXCategoryViewListContainer*/> {
}
...
@implementation DJB2CClassifyWrapperVC
#pragma mark -
...
- (void)bindVM {
    ...
    [self.b2cVM.productSearchDoCategoryByLevOneSubject subscribeNext:^(NSArray<DJB2CCategoryModel *> *categoryModelList) {
        ...
        [categoryModelList enumerateObjectsUsingBlock:^(DJB2CCategoryModel * _Nonnull obj1, NSUInteger idx1, BOOL * _Nonnull stop1) {
            ...
            [obj1.categorys enumerateObjectsUsingBlock:^(DJB2CCategoryModel * _Nonnull obj2, NSUInteger idx2, BOOL * _Nonnull stop2) {
                ...
                rightModel.f_itemType = DJClassifyGoodItemTypeB2C;
    ...
    [self.b2cVM.v2SearchForLHApiSubject subscribeNext:^(RACTuple *x) {
        ...
        DJClassifyGoodsInfoModel *goodsInfoList = x.second;
        @strongify(self)
