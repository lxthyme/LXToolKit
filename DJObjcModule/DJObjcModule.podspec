#
# Be sure to run `pod lib lint DJObjcModule.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'DJObjcModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DJObjcModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lxthyme/DJObjcModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lxthyme' => 'lx314333@gmail.com' }
  s.source           = { :git => 'https://github.com/lxthyme/DJObjcModule.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '13.0'

  s.source_files = 'DJObjcModule/Classes/**/*'

  # s.resource_bundles = {
  #   'DJObjcModule' => ['DJObjcModule/Assets/*.png']
  # }
