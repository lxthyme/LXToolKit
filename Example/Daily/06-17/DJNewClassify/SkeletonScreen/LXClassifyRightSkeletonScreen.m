//
//  LXClassifyRightSkeletonScreen.m
...
@interface LXClassifyRightGoodsItemSkeletonScreen: LXBaseView{
}
...
@implementation LXClassifyRightGoodsItemSkeletonScreen
#pragma mark -
...
@interface LXClassifyRightSkeletonScreen() {
}
@property(nonatomic, strong)UIView *topView;
@property(nonatomic, strong)UIView *topLeftView;
@property(nonatomic, strong)UIView *topRightView;
@property(nonatomic, strong)LXClassifyRightGoodsItemSkeletonScreen *goodsItemSkeletonScreen1;
@property(nonatomic, strong)LXClassifyRightGoodsItemSkeletonScreen *goodsItemSkeletonScreen2;
@property(nonatomic, strong)LXClassifyRightGoodsItemSkeletonScreen *goodsItemSkeletonScreen3;
@end

@implementation LXClassifyRightSkeletonScreen
#pragma mark -
#pragma mark - 🛠Life Cycle
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
...
- (void)prepareUI {
    ...
    self.goodsItemSkeletonScreen1 = [[LXClassifyRightGoodsItemSkeletonScreen alloc]init];
    self.goodsItemSkeletonScreen2 = [[LXClassifyRightGoodsItemSkeletonScreen alloc]init];
    self.goodsItemSkeletonScreen3 = [[LXClassifyRightGoodsItemSkeletonScreen alloc]init];
