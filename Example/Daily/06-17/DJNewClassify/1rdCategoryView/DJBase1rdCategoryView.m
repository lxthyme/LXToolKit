...
@interface DJBase1rdCategoryView()<UICollectionViewDelegate> {
}
...
// @property(nonatomic, assign)DJFirstCategoryType firstCategoryType;
@end

@implementation DJBase1rdCategoryView
#pragma mark -
