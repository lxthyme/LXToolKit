...
@property(nonatomic, strong)RACSubject *queryCartDisposable;
...
- (void)viewDidDisappear:(BOOL)animated {
    ...
    // [self.queryCartDisposable sendNext:@1];
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (goodsInfo.f_itemType) {
        case DJClassifyGoodItemTypeB2C: {
            ...
            DJGoodsList *goods;
            NSString *t_id = [NSString stringWithFormat:@"%ld", itemModel.sid];
            goods = self.allGoodsMap[t_id];
            [cell dataFillWithB2C:itemModel withNum:goods.goodsNumber];
            return cell;
        }
        case DJClassifyGoodItemTypeO2O: {
            ...
            switch (itemModel.f_itemType) {
                case DJClassifyGoodItemTypeO2O: {
                    ...
                    [cell dataFillWithO2O:itemModel withNum:goods.goodsNumber];
                    return cell;
                }
                case DJClassifyGoodItemTypeB2C:
                case DJClassifyGoodItemTypePinCategoryView:
    ...
    switch (goodsInfo.f_itemType) {
        ...
        case DJClassifyGoodItemTypeO2O: {
            ...
            switch (itemModel.f_itemType) {
                ...
                case DJClassifyGoodItemTypeB2C:
                case DJClassifyGoodItemTypePinCategoryView:
                case DJClassifyGoodItemTypeEmpty: break;
            }
        }
        case DJClassifyGoodItemTypePinCategoryView:
        case DJClassifyGoodItemTypeEmpty: break;
