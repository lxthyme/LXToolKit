...
//        t.register(LXMessageCell.self, forCellReuseIdentifier: LXMessageCell.xl_identifier)
        t.register(UINib(nibName: LXMessageCell.xl_typeName, bundle: nil), forCellReuseIdentifier: LXMessageCell.xl_identifier)
...
extension LXStackMessageVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: LXMessageCell.xl_identifier, for: indexPath) as? LXMessageCell else {
            return LXMessageCell(style: .default, reuseIdentifier: LXMessageCell.xl_identifier)
        }
