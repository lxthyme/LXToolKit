...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://gitlab.bl.com/iOS_Business/blmapmodule"
  ...
  s.source       = { :git => "https://gitlab.bl.com/iOS_Business/blmapmodule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "BLMapModule/BLMapModule/**/*.{h,m}"
  ...
  # s.ios.resource  = "icon.png"
   s.ios.resources = "BLMapModule/BLMapModule/Resources/**/*.png"
  ...
  #s.xcconfig = {'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64 i386 x86_64'}
  ...
  s.dependency 'AMapFoundation-NO-IDFA', '1.8.2'
  s.dependency 'AMap3DMap-NO-IDFA','9.7.0'
