...
#import "LXDJCommentFooterView.h"

@interface LXDJCommentChildVC()<UITableViewDataSource, UITableViewDelegate> {
}
@property(nonatomic, strong)UITableView *tableView;

@end

@implementation LXDJCommentChildVC
- (void)dealloc {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LXDJCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:LXDJCommentCell.xl_identifier forIndexPath:indexPath];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    LXDJCommentFooterView *footer = [tableView dequeueReusableHeaderFooterViewWithIdentifier:LXDJCommentFooterView.xl_identifier];
    return footer;
}
...
- (void)prepareTableView {
    ...
    [self.tableView xl_registerForCell:[LXDJCommentCell class]];
    [self.tableView xl_registerForHeaderFooterView:[LXDJCommentFooterView class]];
}
- (void)prepareUI {
