...
#import "DJCommentStarView.h"

#define kDJCommentProfileAvatarWidth 30.f

@interface DJCommentProfileView() {
}
@property(nonatomic, strong)UIImageView *imgViewAvatar;
@property(nonatomic, strong)UILabel *labName;
@property(nonatomic, strong)UILabel *labDate;
@property(nonatomic, strong)DJCommentStarView *starView;

@end

@implementation DJCommentProfileView
#pragma mark -
...
- (DJCommentStarView *)starView {
    if(!_starView){
        DJCommentStarView *v = [[DJCommentStarView alloc]init];
