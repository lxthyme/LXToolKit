...
@interface LXDJCommentPictureView()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
}
...
@implementation LXDJCommentPictureView
#pragma mark -
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    LXDJCommentPictureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:LXDJCommentPictureCell.xl_identifier forIndexPath:indexPath];
...
- (void)prepareCollectionView {
    [self.collectionView xl_registerForCell:[LXDJCommentPictureCell class]];
}
- (void)prepareUI {
...
- (void)masonry {
    ...
    [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@(kLXDJCommentPictureCellWidth));
    }];
}
...
- (UICollectionView *)collectionView {
    if(!_collectionView) {
        ...
        flowLayout.itemSize = CGSizeMake(kLXDJCommentPictureCellWidth, kLXDJCommentPictureCellWidth);
