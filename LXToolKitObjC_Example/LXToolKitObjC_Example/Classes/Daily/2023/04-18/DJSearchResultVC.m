...
@interface DJSearchResultVC()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout> {
}
@property(nonatomic, strong)UISearchBar *searchBar;
@property(nonatomic, strong)UICollectionView *collectionView;
@property(nonatomic, strong)DJSearchHistoryCell *historyTestCell;
...
@implementation DJSearchResultVC
- (void)dealloc {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section == 0) {
        DJSearchHistoryCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DJSearchHistoryCell" forIndexPath:indexPath];
        ...
        if(self.hotList.count > 0) {
            DJSearchHotRankListCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DJSearchHotRankListCell" forIndexPath:indexPath];
            // NSDictionary *item = self.showingHistoryList[indexPath.row];
            // NSString *title = item[@"title"];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    if([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        if(indexPath.section == 0) {
            if(self.showingHistoryList.count > 0) {
                DJSearchResultHeaderView *header = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"DJSearchResultHeaderView" forIndexPath:indexPath];
...
- (void)prepareCollectionView {
    ...
    [self.collectionView registerClass:[DJSearchHistoryCell class] forCellWithReuseIdentifier:@"DJSearchHistoryCell"];
    [self.collectionView registerClass:[DJSearchHotRankListCell class] forCellWithReuseIdentifier:@"DJSearchHotRankListCell"];
    [self.collectionView registerClass:[DJSearchResultHeaderView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"DJSearchResultHeaderView"];
    ...
    [self.collectionView registerClass:[DJSearchResultHeaderView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"UICollectionReusableView"];
}
- (void)prepareUI {
...
- (DJSearchHistoryCell *)historyTestCell {
    if(!_historyTestCell){
        DJSearchHistoryCell *v = [[DJSearchHistoryCell alloc]init];
        _historyTestCell = v;
    }
